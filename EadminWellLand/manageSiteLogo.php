          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Site Logo</h4>
                    ...
                    <div class = "card">
                        <div class="card-header" style="padding: 5px 15px;">
                          <div class = "row">
                              ...
                              <div class = "col-6">
                                  <a href="addLogo" class="btn btn-info" style="float: right;"><i class="fa-solid fa-plus"></i></a>
                              </div>
                          </div>
                      </div>
                      <div class = "card-body">
  ...
  <script type="text/javascript">
    ...
    var table=$('#Form_Table').DataTable(
    {
        ...
        "columns": [
            ...
            { "data" : "header_logo",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                  $(nTd).html(`<img width="100%" height="100px" src="vertical/${oData.header_logo}"/>`);
                } 
              },
              { "data" : "footer_logo",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                  $(nTd).html(`<img width="100%" height="100px" src="vertical/${oData.footer_logo}"/>`);
                } 
              }, 
            { "data" : "id",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                bnTd = `<a href="editLogo?type=view&randomId=${oData.randomId}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;
               
                <a href="editLogo?type=edit&randomId=${oData.randomId}" title="Edit"><i class="far fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;
