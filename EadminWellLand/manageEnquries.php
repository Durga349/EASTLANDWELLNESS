          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Enquires</h4>
  ...
  "columns": [
    ...
    { "data": "id",
      "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
        let bnTd = '';
        bnTd = `<a href="editEnquries?randomId=${oData.randomId}" title="View"><i class="far fa-eye" aria-hidden="true"></i></a>`;
