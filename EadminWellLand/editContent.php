...
$Ser_qry = "select * from home_content where randomId = '".$randid."'";
...
<?php if($_GET['type']=='edit'){?>
                ...
                <div class="row mb-3">
                  ...
                  <input type="text" name="title" id="title" class="form-control" value="<?php echo  $Ser_data[0]['title'];?>">
                </div>
              <div class="col-md-12 mb-3">
...
<?php if($_GET['type']=='view'){?>
             ...
             <div class="row mb-3">
               <div class="col-md-12 mb-3">
                <label for="inputName">Title</label>
                <input type="text" name="title" id="title" class="form-control" value="<?php echo  $Ser_data[0]['title'];?>" readonly>
              </div>
             <div class="col-md-12 mb-3">
