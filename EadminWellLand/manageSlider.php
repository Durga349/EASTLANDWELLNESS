                    ...
                    <div class = "card">
                        <div class="card-header" style="padding: 5px 15px;">
                          <div class = "row">
                              ...
                              <div class = "col-6">
                                  <a href="addSlider" class="btn btn-info" style="float: right;"><i class="fa-solid fa-plus"></i></a>
                              </div>
                          </div>
                      </div>
                      <div class = "card-body">
  ...
  <script type="text/javascript">
    ...
    var table=$('#Form_Table').DataTable(
    {
        ...
        "columns": [
            ...
            { "data" : "image",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                  $(nTd).html(`<img width="50%"  src="vertical/${oData.image}"/>`);
                } 
              },
            { "data" : "id",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                bnTd = `<a href="editslider?type=view&randomId=${oData.randomId}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;
               
                <a href="editslider?type=edit&randomId=${oData.randomId}" title="Edit"><i class="far fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;
