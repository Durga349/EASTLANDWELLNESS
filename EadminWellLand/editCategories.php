...
<?php include('includes/header.php'); 
  ...
  $res_qry = "select * from categories WHERE randomId = '".$randomId."'";
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="catg_name" id="catg_name" value="<?php echo $res_data[0]['catg_name']; ?>">
